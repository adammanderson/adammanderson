...
export default () => (
  <GridWrapper>
    ...
    <GridItem>
      ...
      <P>A reducer is a pure function that takes the previous state and an action as arguments and returns a new state.</P>
    </GridItem>
    <GridItem>
    ...
    <GridItem>
      ...
      <P>React.Suspense, along with React.lazy(), introduced in v16.6, adds new functionality that allows components to wait for something before actually rendering.</P>
    </GridItem>
    <GridItem>
      <MediumHeading>Deployment with now.sh</MediumHeading>
      <P>A reducer is a pure function that takes the previous state and an action as arguments and returns a new state.</P>
